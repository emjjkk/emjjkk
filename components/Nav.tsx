...
export default function Nav() {
    return (
        <div className="flex flex-col items-center w-fit absolute right-5 top-[50%] -translate-y-[50%] gap-3">
            <div><a href="#" className='text-lg text-foreground hover:text-red-500'><LuFeather /></a></div>
            <div><a href="#" className='text-lg text-foreground hover:text-red-500'><LuFolder /></a></div>
            <div><a href="#" className='text-lg text-foreground hover:text-red-500'><LuBird /></a></div>
            <div><a href="#" className='text-lg text-foreground hover:text-red-500'><LuSend /></a></div>
